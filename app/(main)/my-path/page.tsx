...
import { ArrowRight, BookOpenCheck, CalendarDays, CheckCircle2, Circle, ExternalLink, GraduationCap, HeartHandshake, Landmark, ListChecks, School, Sparkles } from 'lucide-react'
...
type PathData = { name: string; stage: Stage | null; tasks: Task[]; savedColleges: { college: { id: string; name: string; slug: string; location: string | null } | null }[]; savedSchools: { school: { id: string; name: string; slug: string; district: string | null; province: string | null } | null }[]; admissions: { id: string; title: string; slug: string; application_deadline: string | null; institution_name: string | null; education_level: string | null }[]; scholarships: { id: string; title: string; deadline: string | null; amount: string | null }[]; recommendations: Recommendation[] }
