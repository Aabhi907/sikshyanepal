...
export const alt = 'SikshyaNepal — trusted education information for Nepal'
  ...
  return new ImageResponse(
    <div style={{display:'flex',height:'100%',width:'100%',flexDirection:'column',justifyContent:'space-between',background:'#f8fafc',padding:'72px 82px',fontFamily:'Arial, sans-serif',color:'#0f172a'}}>
      ...
      <div style={{display:'flex',maxWidth:950,flexDirection:'column'}}>
        <div style={{fontSize:72,fontWeight:800,lineHeight:1.08,letterSpacing:'-2px'}}>Make your next education choice clearer.</div>
        <div style={{marginTop:28,fontSize:29,lineHeight:1.4,color:'#475569'}}>Compare colleges, follow admissions, and check results from sources worth trusting.</div>
      </div>
