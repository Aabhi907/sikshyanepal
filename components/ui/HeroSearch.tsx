  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-stretch border-2 border-[#1847c4] rounded-xl bg-white overflow-hidden shadow-card-md focus-within:shadow-card-lg transition-shadow">
          ...
          <button
            ...
            className="flex-shrink-0 m-1.5 px-6 bg-[#1847c4] text-white text-sm font-semibold
                       rounded-lg hover:bg-[#1340b0] transition-colors active:scale-[0.98]"
          >
            Search
          </button>
        </div>
